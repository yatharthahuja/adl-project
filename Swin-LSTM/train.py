...
from dataset import Moving_MNIST, CustomDataset
...
def setup(args):
    ...
    # print(f'Train dataset shape: {train_dataset.datas.shape}')
    # print(f'Valid dataset shape: {valid_dataset.datas.shape}')

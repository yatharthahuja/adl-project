...
class Moving_MNIST_Test(Dataset):
    def __init__(self, args):
        ...
        self.num_frames_input = 10 #args.num_frames_input
        self.num_frames_output = 10 #args.num_frames_output
        self.num_frames_total = self.num_frames_input + self.num_frames_output

        self.dataset = np.load('/home/akirscht/robot/adl-project/models/SwinLSTM/data/mnist_test_seq.npy')
